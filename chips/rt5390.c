	...
	IN PRTMP_ADAPTER		pAd)
{
	...
	if (IS_RT5392(pAd))
		pChipOps->AsicResetBbpAgent = RT5392_AsicRecalBbpAgent;
...
VOID NICInitRT5390RFRegisters(IN PRTMP_ADAPTER pAd)
{
	...
	if (IS_RT5392(pAd))
	{
		...
		{
#ifdef RTMP_MAC_PCI /* For RT5392 */
			if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R01)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x17;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R06)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0xE0;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R21)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x8D;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R23)) /* >= RT5392C */
 			{
				RF5392RegTable[i].Value = 0x0B;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R25)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x80;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R42)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0xD5;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R43)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x9B;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R51)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x3A;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R52)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x48;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R53)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x44;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R57)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x00;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R59)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x07;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R60)) /* >= RT5392C */
			{
				RF5392RegTable[i].Value = 0x45;
			}
			else if (IS_RT5392C(pAd) && (RF5392RegTable[i].Register == RF_R61)) /* >= RT5392C */
			{
	...
	else if (IS_RT5390(pAd) && !IS_MINI_CARD(pAd))
	{
		...
		for (i = 0; i < NUM_RF_5390_REG_PARMS; i++)
		{
			...
			if (IS_RT5390F(pAd) && (RF5390RegTable[i].Register == RF_R46)) /* >= RT5390F */
			{
				RF5390RegTable[i].Value = 0x73;
			}
			else if (IS_RT5390F(pAd) && (RF5390RegTable[i].Register == RF_R06)) /* >= RT5390F */
			{
				RF5390RegTable[i].Value = 0xE0;
			}
			else if (IS_RT5390F(pAd) && (RF5390RegTable[i].Register == RF_R61)) /* >= RT5390F */
			{
				RF5390RegTable[i].Value = 0xD5;
			}

			if ((IS_RT5390F(pAd) || IS_RT5390(pAd)) && (RF5390RegTable[i].Register == RF_R53)) /* >= RT5390F or RT5390 */
			{
